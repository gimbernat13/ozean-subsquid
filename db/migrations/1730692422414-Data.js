module.exports = class Data1730692422414 {
    name = 'Data1730692422414'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "reward_history" ("id" character varying NOT NULL, "amount" numeric NOT NULL, "block" integer NOT NULL, "timestamp" numeric NOT NULL, "user_reward_id" character varying, "transfer_id" character varying, CONSTRAINT "PK_1790d3b4570b3f09a5d486b8193" PRIMARY KEY ("id"))`)
